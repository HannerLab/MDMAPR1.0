...
shinyUI(navbarPage( title = "MDMAPR",
                    
                    ########################### PAGE 01 MAPPING ###############################
                    
                    tabPanel("Dynamic Mapping Visualization",
                             ...
                             absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                           ...
                                           numericInput("thr", "Max. Ct Threshold for Presence:", 40, min = 1, max = 50),
                    ...
                    tabPanel("Data File Preparation",
